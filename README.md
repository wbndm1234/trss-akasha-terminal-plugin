...
[![访问量](https://profile-counter.glitch.me/trss-akasha-terminal-plugin/count.svg)](https://github.com/wbndm1234/trss-akasha-terminal-plugin)
...
```base
git clone --depth 1 https://github.com/wbndm1234/trss-akasha-terminal-plugin.git/plugins/akasha-terminal-plugin
```
